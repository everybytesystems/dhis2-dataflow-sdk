...
android {
    namespace = "com.everybytesystems.ebscore.dhis2.data"
...
mavenPublishing {
    coordinates(
        ...
        artifactId = "dhis2-data",
        version = "1.0.0"
    )
    
    pom {
        name.set("EBSCore DHIS2 Data")
        description.set("DHIS2 data management module for EBSCore SDK")
    }
}