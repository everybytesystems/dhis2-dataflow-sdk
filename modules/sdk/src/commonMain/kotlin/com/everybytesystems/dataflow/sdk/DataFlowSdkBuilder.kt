...
/**
 * Builder for creating DataFlowSdk instances with fluent configuration
 */
class DataFlowSdkBuilder {
     ...
     */
    suspend fun build(): ApiResponse<DataFlowSdk> {
        ...
        return DataFlowSdk.create(config)
    }
    
    /**
     * Build the DataFlowSdk instance with known version (skip version detection)
     */
    fun buildWithVersion(version: DHIS2Version): DataFlowSdk {
        val url = baseUrl ?: throw IllegalStateException("Base URL is required")
        ...
        return DataFlowSdk.createWithVersion(config, version)
    }
    ...
    companion object {
         ...
         */
        fun newBuilder() = DataFlowSdkBuilder()
